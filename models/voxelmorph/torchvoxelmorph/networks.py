...
class SPM(nn.Module):
    def __init__(self, channel):
        ...
        self.conv2d1 = nn.Conv2d(channel, channel, kernel_size=1,stride=1,padding=0)
...
class ConvBNR(nn.Module):
    def __init__(self, inplanes, planes, kernel_size=3, stride=1, dilation=1, bias=False):
        ...
        self.con = nn.Conv2d(inplanes, planes, 1, stride=stride, padding=0, dilation=dilation, bias=bias)

    def forward(self, x):
        return self.block(x)+self.con(x)
...
class VxmDense(LoadableModel):
    ...
    def forward(self, source, target, registration=False):
        ...
        if not registration:
            ...
            return y_source, pos_flow,y_target
